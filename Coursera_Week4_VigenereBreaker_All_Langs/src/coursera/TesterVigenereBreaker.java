...
public class TesterVigenereBreaker {
	...
	public void testdecryptKnowKey(int key) {
		CaesarCipher cc = new CaesarCipher(key);
		String message = initFile();
		System.out.println("testdecryptKnowKey() started  with known key = "
				+ key);
		System.out.println("ORIGINAL MESSAGE:");
		System.out.println(message);
		System.out.println("\nDECRYPTED MESSAGE:");
	...
	public void testdecryptDontKnowKeyNotEnglish(char ch) {
		...
		String message = initFile();
		System.out
				.println("testdecryptDontKnowKeyNotEnglish started with char = "
						+ ch);
		System.out.println("ORIGINAL MESSAGE:");
		System.out.println(message);
		System.out.println("The key was count = " + cracker.getKey(message));
	...
	public void testdecryptVigenereCipherEncrypt(int[] arrInt) {
		...
		String message = initFile();
		System.out
				.print("testdecryptVigenereCipherEncrypt(int [] arrInt) started with arrInt = ");
		printArrInt(arrInt);
		System.out.println("ORIGINAL MESSAGE:");
		System.out.println(message);
		System.out.println("\nDECRYPTED MESSAGE:");
	...
	public void testencryptVigenereCipherEncrypt(int[] arrInt) {
		...
		String message = initFile();
		System.out
				.print("testencryptVigenereCipherEncrypt(int [] arrInt) started with arrInt = ");
		printArrInt(arrInt);
		System.out.println("ORIGINAL MESSAGE:");
		System.out.println(message);
		System.out.println("\nENCRYPTED MESSAGE:");
	...
	public void testVigenereBreakerSliceString(String message, int whichSlice,
			int totalSlices) {
	...
	public void testbreakVigenere(int klength, char mostCommon) {
		...
		VigenereBreaker vb = new VigenereBreaker();
		System.out.println(vb.breakVigenere(klength, mostCommon));
	}

	public void testbreakForLanguage(int largestKeyLength, char mostCommon) {
		System.out.println("testbreakForLanguage started");
...
//		vb.tryKeyLength(encrypted, 38, 'e');
	...
	public void testAllLang() throws FileNotFoundException {
		VigenereBreaker vb = new VigenereBreaker();
		vb.breakVigenere();
	}
